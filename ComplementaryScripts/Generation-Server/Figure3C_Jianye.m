...
% 
 ...
 [sol model1 complexFileName total_protein_molecules_model ]=modelGenerationGECKO_Jianye(model,'minimum', mu,atpCost,'min_glucose',22.6,T,0, overExpressed, sprintf('Jianye_Ribosome_Max_Mu_GEKO_Glucose_%f_T%d_Copies_%d_k_%d.lp',mu,T,0,kk),complex_list,compartment,'Soplex-1.6',kk,1);
...
system(sprintf('./myResults1 %s','Jianye_Ribosome_Max_Mu_GEKO_Glucose'),'-echo');
