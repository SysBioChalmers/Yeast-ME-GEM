function constrain = plasmaConditionCarbon(model, mu,kdeg)

[a b Proteins_MW]=xlsread('TableS1.xlsx','MW');

[a b complex_list]=xlsread('TableS1.xlsx','Plasma_carbon');

 constrain='';
complex_list=unique(complex_list(:,1));
for i=2:numel(complex_list(:,1)) %2
