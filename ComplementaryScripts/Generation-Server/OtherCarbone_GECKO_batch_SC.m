...
[sol{i} glc  ]=growthSearchDynamic(new_MyModel, 'SC',atpCost,0,T, copies, overExpressed, complex_list,compartment,0, 0.6,fileName)
...
[ss model complexFileName ]=modelGenerationGeko(new_MyModel,'SC', sol{i}.mu,atpCost,'min_carbon',0,T,0, overExpressed, fileName,complex_list,compartment);
