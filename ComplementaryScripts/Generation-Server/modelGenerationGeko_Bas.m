function [sol model complexFileName molecule_number]=modelGenerationGeko_Angelaca(MyModel,media,mu1,atpCost,objective,glucoseUptake,T,copies, overExpressed, fileName,complex_list,compartment,SoplexVersion,Iteration)
...
molecule_number_mu_max=floor(proteinRatio(0.46)*13/(average_protein_length*average_amino_acids)*6.023e23/1e12); 

mitochondrionVolume=5;%Ratio of mitochondrion to cell volume is equal 1-2%
cyto_volume =4;
plasma_area=40;
plasma_budjet=10;
Vmax_NH4 = 7;
