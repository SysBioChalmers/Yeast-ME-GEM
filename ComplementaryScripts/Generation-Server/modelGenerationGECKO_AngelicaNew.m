...
mu=mu1; 
sigma_plasma = 1;
c_mim=82; %67 is the best parameter

average_amino_acids=128;
average_protein_length=300;

cw=[15.10 15.10 15.04  14. 14.0 14.55];
gr=[0.2 0.23 0.27 0.3 0.32 0.34];
index=find(gr==mu);
cellweight=cw(index);
cellweight=13;

molecule_number=floor(proteinRatio_Angelica(mu)*cellweight/(average_protein_length*average_amino_acids)*6.023e23/1e12); 
molecule_number_mu_max=200;%floor(proteinRatio_Angelica(0.46)*13/(average_protein_length*average_amino_acids)*6.023e23/1e12); 
...
f_rRNA=0.85;
kt=(1/0.32); %the best parameter is 0.22
r0=0.08; %the best parameter is 0.14
