function [geneList PredictedExpression ribosomeRatio] = modelProteinAllocationMass(model,solFile,mu,kdeg,SoplexVersion)
...
for i=1:numel(geneList)
    ...
    PredictedExpression(i)=sum(Expression(index)*13*6.02e8)/molecule_number; % the unit is g per gDW %%*13*6.023e8; %%
end
