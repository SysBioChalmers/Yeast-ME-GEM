function [sol model complexFileName molecule_number]=modelGenerationGECKO_batch(MyModel,media,mu1,atpCost,objective,glucoseUptake,T,copies, overExpressed, fileName,complex_list,compartment,SoplexVersion,Iteration,active_translation)
...
upr=-1.6667*mu + 0.76;
upr=0.4; %best parameter is 0.26
...
f_rRNA=0.85;
kt=(1/0.25); %the best parameter is 0.22
r0=0.09; %the best parameter is 0.14
...
fprintf(fptr,'PMRcarbon:   %s <= %f\n',plasmaConditionCarbon(model, mu,kdeg),0.2*plasma_area);
