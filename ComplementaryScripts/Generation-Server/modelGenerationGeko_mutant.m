function [sol model complexFileName molecule_number]=modelGenerationGeko_mutant(MyModel,media,mu1,atpCost,objective,glucoseUptake,T,copies, overExpressed, fileName,complex_list,compartment,SoplexVersion,Iteration,active_translation)
...
molecule_number_mu_max=0;%floor(proteinRatio(0.46)*13/(average_protein_length*average_amino_acids)*6.023e23/1e12); 
