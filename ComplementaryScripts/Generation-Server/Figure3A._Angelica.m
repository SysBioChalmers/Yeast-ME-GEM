...
mu1= [0.20 0.23 0.27 0.30 0.32 0.34] ;
atpCost.gam=33;
atpCost.ngam=1;
 T1=[33 36 38];
...
% 
 ...
 Sfactor= Estimate_abundance(model,mu, complexFileName,sprintf('Angelica_Glucose_%f_T%d_Copies_%d_k_%d.lp.out',mu,T,0,kk), ExpressionFileName,total_protein_molecules_model,'Soplex-3.0',kk);
