function [sol model complexFileName molecule_number]=modelGenerationGECKO_Temp(MyModel,media,mu1,atpCost,objective,glucoseUptake,T,copies, overExpressed, fileName,complex_list,compartment,SoplexVersion,Iteration,active_translation)
...
weight_sigma =sigma*sigmaTemp/(mu + kdeg);
f=56517.2/1000.0;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
...
%sigmaTem with the ribosome
if T>=Topt
kcat_ribo= kcat_rate; % no sigmaTemp;
else
...
for i=1:numel(model.rxns)
    ...
    if numel(name)>0 && numel(name1)==0
        ...
        lengthIndex =find(ismember(Proteins_length(:,1),gene));
        L=cell2mat(Proteins_length(lengthIndex,2));
            
        T_index=10:0.5:40;
        Ti =find(T_index==T);
        
        gene=strrep(gene,'w','W');
        gene=strrep(gene,'c','C');

          
        lengthIndex =find(ismember(native_ratio(:,1),gene));
        if numel(lengthIndex)==0
            native=1;
        %    fprintf('Not found gene in delta G %s\n',geneName);
        else
            %native=1+ (1- cell2mat(native_ratio(lengthIndex,Ti+2)));
           native=1;
        end
        ...
        if strcmp(ve,'')
                ...
                %total mass
                ve_total=sprintf('%f X%d',native*MW, i);
                ve_total_molecules=sprintf('%.15f X%d', native, i);
               ...
               %total mass
               ve_total=sprintf('%s + %f X%d%c',ve_total,native*MW,i,sep);
               ve_total_molecules=sprintf('%s + %.15f X%d%s', ve_total_molecules,native,i,sep);
        end
        r=r+1;
    end
end
...
misFoldingConstraintHspNew(model,fptr,UnFoldRatio,mu,5,kdeg,sigmaTemp,RefoldingRatio,T);
