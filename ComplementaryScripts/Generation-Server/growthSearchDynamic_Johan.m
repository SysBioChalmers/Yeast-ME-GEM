function [sol1 glc]= growthSearchDynamic_Johan(model, medium,atpCost,uptake,T, copies, overExpressed, complex_list,compartment,gr_min, gr_max,fileName,SoplexVersion,active_translation)
...
while (abs(gr_max - gr_min)>=1e-3)
  ...
  sol=modelGenerationGECKO_Johan(model,medium,gr,atpCost,'min_carbon',uptake,T,copies, overExpressed, fileName,complex_list,compartment,SoplexVersion,1,active_translation);
