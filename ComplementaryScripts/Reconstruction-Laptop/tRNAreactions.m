function [rxnID rxnNames eq modification]=tRNAreactions(base,modification_list,Reaction,Position)
eq={};
k=1;
...
for k=1:numel(modification_list);
    ...
    rxnID {k,1} =sprintf('tRNA_%s_%s_%s_%d',cell2mat(Position(i,1)),cell2mat(Position(i,2)),cell2mat(Position(i,4)),cell2mat(Position(i,3)));
    rxnNames {k,1} = sprintf('tRNA_%s_%s_%s_%d',cell2mat(Position(i,1)),cell2mat(Position(i,2)),cell2mat(Position(i,4)),cell2mat(Position(i,3)));
