function newModel= addProtein2Model(newModel)
...
eq=sprintf('%d H2O [cytoplasm] + %d ATP [cytoplasm] + %d GTP [cytoplasm] + Met1-tRNA(AUG) [cytoplasm] + %s => %s_peptide [cytoplasm] + %d ADP [cytoplasm] + %d GDP [cytoplasm] + %d phosphate [cytoplasm] + %d H+ [cytoplasm] + tRNA(AUG1) [cytoplasm] + %s', total_h2o, total_atp,total_gtp,eq_substrates,gene,total_atp,total_gtp,total_pi,total_h,eq_product);
% eq=sprintf('%d H2O [cytoplasm] + %d ATP [cytoplasm] + %d GTP [cytoplasm] + Met1-tRNA(AUG) [cytoplasm] + %s => %s_peptide [cytoplasm] + %d ADP [cytoplasm] + %d GDP [cytoplasm] + %d phosphate [cytoplasm] + %d H+ [cytoplasm]', total_h2o, total_atp,total_gtp,eq_substrates,gene,total_atp,total_gtp,total_pi,total_h);
